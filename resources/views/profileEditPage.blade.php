                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="tel" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') ? old('mobile') : Auth::user()->mobile }}" required autocomplete="mobile">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                @if(str_contains($_SERVER['REQUEST_URI'], 'driver'))
                                    <a href="{{route('driver.profile')}}">Cancel</a>
                                @else
